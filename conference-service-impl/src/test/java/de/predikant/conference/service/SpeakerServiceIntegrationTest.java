...
public class SpeakerServiceIntegrationTest {
    ...
    public void updateSpeakerTest() throws Exception {
        ...
        final Speaker updatedSpeaker = speakerService.updateSpeaker(speaker);
    ...
    public void findSpeakerByIdTest() throws Exception {
        ...
        final Speaker foundSpeaker = speakerService.findSpeakerById(speaker.getId());
    ...
    public void findAllTest() throws Exception {
        ...
        final List<Speaker> foundSpeakers = speakerService.findAll();
