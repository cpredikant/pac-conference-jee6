...
public class ConferenceServiceTestITCase {
    ...
    public void createConferenceTest() throws Exception {
        ...
        conference.setStart(sdf.parse("01.01.2022 12:00:00"));
        conference.setEnd(sdf.parse("10.01.2022 12:00:00"));
    ...
    public void findAllTest() throws Exception {
        ...
        c1.setName("findAll1");
        c1.setStart(sdf.parse("01.01.2022 12:00:00"));
        c1.setEnd(sdf.parse("10.01.2022 12:00:00"));
        ...
        c2.setName("findAll2");
        c2.setStart(sdf.parse("01.01.2022 12:00:00"));
        c2.setEnd(sdf.parse("10.01.2022 12:00:00"));
